...
import { PasswordFormData, passwordSchema } from "../profile/schemas/password.schema";
  ...
  return (
    <>
      <div className="rounded-[24px] border border-[#E8ECF4] bg-white p-5 shadow-sm">
        <div>
          <h2 className="text-[32px] font-semibold text-gray1">Security Settings</h2>
        ...
        <div className="mt-8">
          <h3 className="text-xl font-semibold text-gray1">Password change</h3>
          <p className="mt-2 max-w-[644px] text-sm leading-6 text-gray2">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-6">
          <div className="max-w-[320px]">
            <Input
              ...
              id="oem-settings-current-password"
              type="password"
          ...
          <div className="grid max-w-[664px] gap-6 md:grid-cols-2">
            <Input
              {...register("newPassword")}
              id="oem-settings-new-password"
              type="password"
              label="New password"
            ...
            <Input
              ...
              id="oem-settings-confirm-password"
              type="password"
